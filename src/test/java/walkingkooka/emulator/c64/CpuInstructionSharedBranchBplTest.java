...
public final class CpuInstructionSharedBranchBplTest extends CpuInstructionSharedBranchTestCase<CpuInstructionSharedBranchBpl> {
    ...
    @Override
    public Class<CpuInstructionSharedBranchBpl> type() {
        return CpuInstructionSharedBranchBpl.class;
    }
}
