...
public abstract class CpuInstructionClearOrSetTestCase<I extends CpuInstructionClearOrSet> extends CpuInstructionTestCase<I> {

    CpuInstructionClearOrSetTestCase() {
        super();
    }
