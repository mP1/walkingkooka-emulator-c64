...
public final class CpuInstructionSharedTransferTaxTest extends CpuInstructionSharedTransferTestCase<CpuInstructionSharedTransferTax> {
    ...
    @Override
    public Class<CpuInstructionSharedTransferTax> type() {
        return CpuInstructionSharedTransferTax.class;
    }
}
