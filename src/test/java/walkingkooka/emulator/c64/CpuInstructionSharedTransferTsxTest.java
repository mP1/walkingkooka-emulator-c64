...
public final class CpuInstructionSharedTransferTsxTest extends CpuInstructionSharedTransferTestCase<CpuInstructionSharedTransferTsx> {
    ...
    @Override
    public Class<CpuInstructionSharedTransferTsx> type() {
        return CpuInstructionSharedTransferTsx.class;
    }
}
