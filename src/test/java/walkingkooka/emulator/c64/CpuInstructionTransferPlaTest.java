...
public final class CpuInstructionTransferPlaTest extends CpuInstructionTransferTestCase<CpuInstructionTransferPla> {
    ...
    @Override
    public CpuInstructionTransferPla createCpuInstruction() {
        return CpuInstructionTransferPla.INSTANCE;
    }

    @Override
    public Class<CpuInstructionTransferPla> type() {
        return CpuInstructionTransferPla.class;
    }
}
