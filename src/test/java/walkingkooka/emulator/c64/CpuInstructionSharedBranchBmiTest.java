...
public final class CpuInstructionSharedBranchBmiTest extends CpuInstructionSharedBranchTestCase<CpuInstructionSharedBranchBmi> {
    ...
    @Override
    public Class<CpuInstructionSharedBranchBmi> type() {
        return CpuInstructionSharedBranchBmi.class;
    }
}
