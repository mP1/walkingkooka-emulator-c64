...
public final class CpuInstructionSharedBinaryConsumerBitZpTest extends CpuInstructionSharedBinaryConsumerBitTestCase<CpuInstructionSharedBinaryConsumerBitZp> {
    ...
    @Override
    public CpuInstructionSharedBinaryConsumerBitZp createCpuInstruction() {
    ...
    @Override
    public Class<CpuInstructionSharedBinaryConsumerBitZp> type() {
        return CpuInstructionSharedBinaryConsumerBitZp.class;
    }
}
