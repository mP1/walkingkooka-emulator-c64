...
public final class CpuInstructionRtsTest extends CpuInstructionTestCase<CpuInstructionRts> {
    ...
    @Override
    public CpuInstructionRts createCpuInstruction() {
    ...
    @Override
    public Class<CpuInstructionRts> type() {
        return CpuInstructionRts.class;
    }
}
