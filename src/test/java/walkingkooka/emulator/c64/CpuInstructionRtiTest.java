...
public final class CpuInstructionRtiTest extends CpuInstructionTestCase<CpuInstructionRti> {
    ...
    @Override
    public CpuInstructionRti createCpuInstruction() {
    ...
    @Override
    public Class<CpuInstructionRti> type() {
        return CpuInstructionRti.class;
    }
}
