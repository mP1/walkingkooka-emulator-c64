...
abstract class C64ExpressionFunction<T, C extends TerminalExpressionEvaluationContext> implements ExpressionFunction<T, C> {

    C64ExpressionFunction(final String name) {
