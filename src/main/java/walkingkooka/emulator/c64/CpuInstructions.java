...
public final class CpuInstructions implements PublicStaticHelper {
    ...
    /**
     * {@see CpuInstructionSharedStoreXStxZpY}
     */
    public static CpuInstruction stxZpY() {
        return CpuInstructionSharedStoreXStxZpY.instance();
    }

    /**
     * {@see CpuInstructionSharedStoreYStyAbs}
     */
    public static CpuInstruction styAbs() {
        return CpuInstructionSharedStoreYStyAbs.instance();
    }
    
    /**
     * {@see CpuInstructionSharedStoreYStyZp}
     */
    public static CpuInstruction styZp() {
        return CpuInstructionSharedStoreYStyZp.instance();
    }

    /**
     * {@see CpuInstructionSharedStoreYStyXZp}
     */
    public static CpuInstruction styZpX() {
        return CpuInstructionSharedStoreYStyZpX.instance();
    }
